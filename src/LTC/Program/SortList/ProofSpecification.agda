...
module LTC.Program.SortList.ProofSpecification where
...
open import LTC.Program.SortList.Closures.ListOrd using ( flatten-ListOrd )
open import LTC.Program.SortList.Closures.Tree using ( makeTree-Tree )
open import LTC.Program.SortList.Closures.TreeOrd using ( makeTree-TreeOrd )
