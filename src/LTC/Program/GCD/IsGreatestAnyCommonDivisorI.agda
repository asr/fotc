...
module LTC.Program.GCD.IsGreatestAnyCommonDivisorI where

open import LTC.Base

open import Common.Function using ( _$_ )

open import LTC.Data.Nat.Divisibility.PropertiesI using ( 0∤x ; x∣S→x≤S )
...
open import LTC.Program.GCD.IsDivisibleI using ( Divisible )
