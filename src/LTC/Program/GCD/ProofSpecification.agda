...
module LTC.Program.GCD.ProofSpecification where
...
open import LTC.Program.GCD.IsCommonDivisor using ( CD ; gcd-CD )
open import LTC.Program.GCD.IsDivisible using ( gcd-Divisible )
open import LTC.Program.GCD.IsGreatestAnyCommonDivisor using ( GACD ; gcd-GACD )
open import LTC.Program.GCD.IsN using ( gcd-N )
