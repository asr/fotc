...
module LTC.Program.GCD.IsGreatestAnyCommonDivisor where
...
open import LTC.Program.GCD.IsCommonDivisor using ( CD )
open import LTC.Program.GCD.IsDivisible using ( Divisible )
