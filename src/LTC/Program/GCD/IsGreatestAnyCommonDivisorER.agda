...
module LTC.Program.GCD.IsGreatestAnyCommonDivisorER where
...
open import LTC.Program.GCD.IsCommonDivisorER using ( CD )
open import LTC.Program.GCD.IsDivisibleER using ( Divisible )
