...
module LTC-PCF.Program.GCD.IsGreatestAnyCommonDivisorATP where
...
open import LTC-PCF.Data.Nat.Divisibility.PropertiesC using ( 0∤x )
open import LTC-PCF.Data.Nat.Divisibility.PropertiesATP using ( x∣S→x≤S )
open import LTC-PCF.Data.Nat.Inequalities using ( LE )

open import LTC-PCF.Program.GCD.IsCommonDivisorATP using ( CD )
open import LTC-PCF.Program.GCD.IsDivisibleATP using ( Divisible )
