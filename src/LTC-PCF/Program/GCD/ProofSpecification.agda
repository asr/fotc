...
module LTC-PCF.Program.GCD.ProofSpecification where
...
open import LTC-PCF.Program.GCD.IsCommonDivisor using ( CD ; gcd-CD )
open import LTC-PCF.Program.GCD.IsDivisible using ( gcd-Divisible )
open import LTC-PCF.Program.GCD.IsGreatestAnyCommonDivisor
  using ( GACD ; gcd-GACD )
open import LTC-PCF.Program.GCD.IsN using ( gcd-N )
