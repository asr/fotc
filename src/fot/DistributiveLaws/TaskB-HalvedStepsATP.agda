...
-- the numbers used in DistributiveLaws.TaskB-I.
  ...
  xzy = x · z · y
  yxz = y · x · z
  {-# ATP definition xyu xzu xzy yxz #-}

  x·zu = x · (z · u)
  x·zy = x · (z · y)
  {-# ATP definition x·zu x·zy #-}
  ...
  xz·yu = x · z · (y · u)
  xz·yz = x · z · (y · z)
  {-# ATP definition xz·xy xz·yu xz·yz #-}
  ...
  -- 25 March 2013: Only Equinox 5.0alpha (2010-06-29) proved the theorem (240 sec).
