...
module Interactive.FOTC.Program.Division.CorrectnessProof where
...
import Interactive.FOTC.Data.Nat.Induction.NonAcc.WF
open module WFInd = Interactive.FOTC.Data.Nat.Induction.NonAcc.WF.WFInd
