...
module Interactive.FOTC.Data.List.WF-Relation.LT-Length.Induction.Acc.WF where
...
open Interactive.FOTC.Data.Nat.Induction.Acc.WF.<-WF
...
open module InvImg =
  Interactive.FOTC.Induction.WF.InverseImage {List} {N} {_<_} lengthList-N
...
-- Adapted from Interactive.FOTC.Data.Nat.Induction.Acc.WellFoundedInduction.WF₁-LT.
module WF₁-LTL where
