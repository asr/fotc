...
module Interactive.FOTC.Relation.Binary.Bisimilarity.Type where
...
-- (Interactive.FOTC.Relation.Binary.Bisimulation).
...
-- point of the bisimulation functional (Interactive.FOTC.Relation.Binary.Bisimulation).
postulate
  ≈-out : ∀ {xs ys} → xs ≈ ys →
