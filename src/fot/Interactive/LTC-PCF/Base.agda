...
{-
Interactive.LTC-PCF.                              The logical framework (Agda)
...
module Interactive.LTC-PCF.Base where
...
------------------------------------------------------------------------------
-- The term language of Interactive.LTC-PCF.correspond to the PCF terms.
...
postulate
  _·_                   : D → D → D    -- Interactive.LTC-PCF.application.
  lam                   : (D → D) → D  -- Interactive.LTC-PCF.λ-abstraction.
  fix                   : (D → D) → D  -- Interactive.LTC-PCF.fixed-point operator.
  true false if         : D            -- Interactive.LTC-PCF.partial Booleans.
  zero succ pred iszero : D            -- Interactive.LTC-PCF.partial natural numbers.
