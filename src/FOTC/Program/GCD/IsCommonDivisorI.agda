...
module FOTC.Program.GCD.IsCommonDivisorI where
...
open import FOTC.Data.Nat.Divisibility.Properties using ( S∣0 )
...
open import FOTC.Data.Nat.PropertiesI using ( ∸-N )

open import FOTC.Program.GCD.Definitions using ( ¬x≡0∧y≡0 ; CD )
