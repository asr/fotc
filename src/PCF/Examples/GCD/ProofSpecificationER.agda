...
module PCF.Examples.GCD.ProofSpecificationER where

open import LTC.Base

open import PCF.Examples.GCD.GCD using ( ¬x≡0∧y≡0 ; gcd )
open import PCF.Examples.GCD.IsCommonDivisorER using ( CD ; gcd-CD )
open import PCF.Examples.GCD.IsDivisibleER using ( gcd-Divisible )
open import PCF.Examples.GCD.IsGreatestAnyCommonDivisorER
  using ( GACD ; gcd-GACD )
