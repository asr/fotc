...
module PCF.Examples.GCD.IsDivisible where
...
open import PCF.Examples.GCD.IsCommonDivisor using ( CD )

open import PCF.LTC.Data.Nat
  using ( _-_
        ; N ; sN ; zN  -- The LTC natural numbers type.
        )
open import PCF.LTC.Data.Nat.Divisibility using ( _∣_ )
open import PCF.LTC.Data.Nat.Divisibility.Properties
  using ( x∣y→x∣z→x∣y-z )
open import PCF.LTC.Data.Nat.Induction.Lexicographic
  using ( wfIndN-LT₂ )
open import PCF.LTC.Data.Nat.Inequalities using ( GT ; LE ; LT₂ )
