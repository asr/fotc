...
module Draft.FO-LTC-PCF.Program.GCD.Partial.ProofSpecificationI where
...
open import Draft.FO-LTC-PCF.Program.GCD.Partial.CommonDivisorI using ( gcd-CD )
open import Draft.FO-LTC-PCF.Program.GCD.Partial.Definitions using ( x≢0≢y )
open import Draft.FO-LTC-PCF.Program.GCD.Partial.DivisibleI using ( gcd-Divisible )
...
open import Draft.FO-LTC-PCF.Program.GCD.Partial.TotalityI using ( gcd-N )
